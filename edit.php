...
<html lang="en">
    ...
    <div class = "container ">
					...
					<form action="" method="POST">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-5">
								...
								<input type="text" name="namaWP"class="form-control" id="namaWP" value = "<?=$dataedit["namawp"]?>"required>
							</div>
						...
						<div class="form-row">
							<div class="form-group col-md-5">
								...
								<input type="text" class="form-control" name="ndply" id="ndply" value="<?=$dataedit["ndply"]?>">
							</div>
							<div class="form-group col-md-3">
								<label for="seksi">Seksi Tujuan</label>
								<select name="seksi" id="seksi" class="form-control">
									<option selected><?=$dataedit["seksi"]?></option>
							...
							<div class="form-group col-md-4">
								...
								<?php 
									$tglinput = $dataedit["tanggalndply"];
								?>
								<input type="date" class="form-control" name="tanggalndply" id="tanggalndply" value = "<?=$tglinput?>">
							</div>
						</div>
						<div class = "row text-center">
							<div class= "col">
								<button type="submit" name="edit"class="btn btn-primary float-right">Ubah</button>
							</div>
							<div class= "col">
								<a class="btn btn-secondary float-left" type="button" href="waskonekst.php">Kembali</a>
							</div>
						</div>
					</form>
				</div>
		...
		<div class="footer fixed-bottom text-center text-white bg-primary pt-3 pb-1 mt-2">
      <footer>
